...
<body>
    <section id="start">
        ...
        <header role="banner" class="container">
            ...
            <h2 title="This is what I'm doing right now...">I am majoring in Computer Science Engineering MSc and,<br>aside to my studies, I am a <abbr title="PHP: Hypertext PreProcessor">PHP</abbr> and more recently a <abbr title="Ruby on Rails">RoR</abbr> developer...</h2>
